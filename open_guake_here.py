...
"""
    This module adds a menu item to the nautilus right-click menu which allows
    to open the guake terminal with a new tab set on the current directory
"""
...
class OpenTerminalGeometry(GObject.GObject, Nautilus.MenuProvider):
    """Implements the 'Open Guake here' extension to the nautilus right-click
       menu
    """

    def __init__(self):
        """Nautilus crashes if a plugin doesn't implement the __init__
           method
        """
        try:
    ...
    def get_file_items(self, window, sel_items):
        """Adds the 'Open Guake here' menu item to the Nautilus right-click
